<%@ page language="C#" masterpagefile="~/Admin/Admin_Master_Page.master" autoeventwireup="true" inherits="Admin_RecivePayment, App_Web_recivepayment.aspx.fdf7a39c" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#ctl00_ContentPlaceHolder1_btn_PaySelect").css('display', 'none');
            myFunction();
        });
        ...
        function GetChekedID() {
            ...
            $("#ctl00_ContentPlaceHolder1_hdnID").val(checkedValues);
        }
        function myFunction() {
            var ids = "";
            var amount = 0;
            ...
            var txtAmt = $("#ctl00_ContentPlaceHolder1_txt_Amount").val();
            txtAmt = txtAmt.replace(/\$/g, '');
            txtAmt = txtAmt.replace(/\,/g, '');
            if (amount == txtAmt) {
                $("#btn_PaySelect2").css('display', 'none');
                $("#ctl00_ContentPlaceHolder1_btn_PaySelect").css('display', 'block');
            } else {
                $("#ctl00_ContentPlaceHolder1_btn_PaySelect").css('display', 'none');
            ...
            $("#ctl00_ContentPlaceHolder1_lblTotalAmount").text(amount.toFixed(2));
        ...
        function MakeVirtualURL() {
            ...
            document.getElementById('<%= hdnUrl.ClientID %>').value=PriUrl;
    ...
    <table align="center">
        ...
        <tr>
            <td colspan="4" align="center">
                <asp:Button ID="btn_PaySelect" runat="server" Text="Pay Selected" ValidationGroup="G"
                    Style="display: none;" OnClientClick="GetChekedID();" class="btn_all" OnClick="btn_PaySelect_Click" />
        ...
        <tr>
            ...
            <td colspan="3" align="left">
                <asp:Label ID="lblTotalAmount" Text="0.00" runat="server" />
            </td>
        </tr>
    </table>
    <br />
