<%@ page language="C#" autoeventwireup="true" inherits="PPLAudit_AddOrManageInvoice, App_Web_addormanageinvoice.aspx.877c4dbe" %>
            ...
            <div class="main_right" style="min-height: 500px;">
                ...
                <table align="center">
                    ...
                    <tr id="trEditDescLoc" runat="server">
                        <td colspan="3">
                            <strong>DESCRIPTION: <asp:TextBox ID="txtSDesc" runat="server" Style="border: 1px solid #ccc;
                                font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: black; border-radius: 5px;
                                padding: 8px; margin: 0; width: 250px;" MaxLength="80" 
                               ></asp:TextBox>
                               
                            &nbsp;Location:&nbsp; <asp:TextBox ID="txtLoc" runat="server" Style="border: 1px solid #ccc; font-family: Arial, Helvetica, sans-serif;
