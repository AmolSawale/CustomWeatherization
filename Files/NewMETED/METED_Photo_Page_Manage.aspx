<%@ page language="C#" masterpagefile="~/NewMETED/METED_Audit_MasterPage.master" autoeventwireup="true" inherits="METED_METED_Photo_Page_Manage, App_Web_meted_photo_page_manage.aspx.e3603123" title="Photo Page" %>
        ...
        <asp:Panel ID="P1" runat="server" Style="display: none;">
                        <table id="Table3" runat="server" backcolor="#E6E6ED" cssclass="pnlBackGround 2-popup cover-bg"
                            ...
                            <tr>
                                <td>
                                <div>
                                    <asp:DataList ID="DTLimages" runat="server" RepeatColumns="3" CellPadding="10" OnItemCommand="DTLimages_ItemCommand1">
                                        <HeaderTemplate>                                        
