<%@ page language="C#" autoeventwireup="true" inherits="AddNewJob, App_Web_addnewjob.aspx.cdcab7d2" title="Add Job" enableeventvalidation="false" %>
...
.hoversize:hover div{display:block !important;}
...
<body>
    <form id="form1" runat="server">
        <div id="loading" runat="server" style="position: absolute; width: 100%; height: 360%; padding-top: 250px; background: rgba(0, 0, 0, 0.54); display: none; z-index: 999; text-align: center;">
                ...
                <ContentTemplate>
                    ...
                    <div class="fix_div">
                        ...
                        <div class="header">
                            ...
                            <div class="">
                                ...
                                <asp:Button ID="btnQuestionaire" runat="server" Text="Questionaire" class="top_btn"
                                    OnClick="btnQuestionaire_Click" />&nbsp;&nbsp;
                                <asp:Button ID="btnPrint" runat="server" Text="Print" class="top_btn" OnClientClick="ClickHereToPrintFull()" OnClick="btnPrint_Click" />&nbsp;&nbsp;
                                <%}
                                    else
                                    { %>
                            ...
                            <div class="head_right">
                                <div class="top_icons">
                                    <ul>
                                        <li>
                                            <asp:LinkButton ID="LnkBack" runat="server" CssClass="back" title="Back" OnClick="LnkBack_Click" Width="22px" Height="20px" CausesValidation="false"></asp:LinkButton></li>
                                        <li><a class="cd-popup-trigger" href="javascript:void(0);">
                                            <img src="images/calendar-128.png" width="20px"/>
                                        </a>
                                        </li>
                                        <li>
                                            <asp:LinkButton ID="LnkHome" runat="server" CssClass="home" title="Home" OnClick="LnkHome_Click" CausesValidation="false"></asp:LinkButton></li>
                                        <li>
                        ...
                        <%}%>
                                        ...
                                        <li>
                                            <asp:LinkButton ID="LnkInvoice" runat="server" class="billing" title="Invoice" OnClick="LnkInvoice_Click"></asp:LinkButton>
                                          <%if (Request.QueryString["JobNew"] == null)
                                              {%>
                                            ...
                                            <%for (int i = 1; i <= Convert.ToInt32(dtInvoice.Rows[0]["IncoiceNo"]); i++)%>
                                            <%{%>
                                                  <li id="Invoice<%=i%>"><a href="Invoice_Crystal.aspx?Back=dj&Jobs=<%=Request.QueryString["Jobs"].ToString()%>&Utility=3&InvoiceNo=<%=i%>">Invoice<%=i%></a> </li>
                                            <%}%>
                                            <%}%>
                                            </ul>
                                            ...
                                            <%for (int i = 1; i <= Convert.ToInt32(dtInvoice.Rows[0]["IncoiceNo"]); i++)%>
                                            <%{%>
                                                  <li id="Invoice<%=i%>"><a href="Invoice_Crystal.aspx?Back=dj&Jobs=<%=Request.QueryString["Jobs"].ToString()%>&Utility=9&InvoiceNo=<%=i%>">Invoice<%=i%></a> </li>
                                            <%}%>
                                             <%}%>
                                            </ul>
                        ...
                        <div id="divPrint">
                            <%if (Request.QueryString["Jobs"] != null)
                                {%>
                            <h3>Update <span id="spnUpJb" runat="server">Job</span><span id="spnUpVen" runat="server">Vendor</span>
                                <%=Request.QueryString["Jobs"].ToString()%>
                            </h3>
                            <%}
                                else
                                { %>
                            <h3>Add New <span id="spnNewJob" runat="server">Jobs</span><span id="spnNewVendor" runat="server">Vendor</span>
                            </h3>
                            <%}%>
                                ...
                                <input type="hidden" name="Language" value="0" id="hdnCheckbox">
                                    ...
                                    <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                        <tr>
                                            ...
                                            <td style="width: 25%">
                                                <span id="dateGoBackReceive" runat="server">Date "Go Back" Received:</span>
                                                <span id="duedate" runat="server">Due Date:</span>
                                                <span id="SpnExt" runat="server" >Ext:</span>
                                            </td>
                                            <td style="width: 25%">
                                                <span id="DateCmplt" runat="server">Date Completed:</span>
                                                <span id="SendDte" runat="server">Send By Date:
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            Display="Dynamic" ErrorMessage="*" ValidationGroup="G"></asp:RequiredFieldValidator>--%>
                                        ...
                                        <tr id="schdt" runat="server">
                                            ...
                                            <%}
                                                ...
                                                { %>
                                                <span id="spnAuditSchdt" runat="server">Audit Scheduled Date:</span>
                                                <span id="spnInspectionSchdt" runat="server" visible="false">Inspection Scheduled Date:</span>
                                                <%}%>
                                            ...
                                            <td valign="top">
                                                ...
                                                <br />
                                                <span>Re-Scheduled Date:</span><br />
                                        ...
                                        <tr>
                                            <td>
                                                <span id="UtilityComp1" runat="server">Utility Company 1:</span>
                                                <span id="Category" runat="server">Category:</span>
                                                <br />
                                            </td>

                                            <td>
                                                <span id="UtilityComp2" runat="server">Utility Company 2:</span>
                                                <span id="Accno" runat="server">Account Number:
                                                </span>
                                            </td>
                                            <td>
                                                <span id="spn" runat="server" visible="false">Zone:</span>
                                                <span id="spnPhone" runat="server">Office Number:</span><%--<span id="SpnExt" runat="server" style="margin-left: 80px;">Ext:</span>--%>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="txtPhone" runat="server" AutoComplete="off" MaxLength="12"
                                                    onkeyup="mask(event,this);" onkeydown="mask(event,this)" Style="width: 170px;"></asp:TextBox>
                                        ...
                                        <tr id="txtFileUpload" runat="server">
                                            ...
                                            <td valign="top">
                                                        ...
                                                        <ItemTemplate>                    
                                                        <asp:LinkButton ID="lnkDownload" Text = "View" CommandArgument = '<%# Eval("PDFName") %>' runat="server" OnClick = "DownloadFile"></asp:LinkButton>
                                                        </ItemTemplate>
                                                        </asp:TemplateField>
                                                        </Columns>
                                                        </asp:GridView>
                                                ...
                                                <asp:DataList ID="grdPdf" runat="server" CellSpacing="6" RepeatDirection="Horizontal" RepeatColumns="4"
                                                    OnDeleteCommand="grdPdf_DeleteCommand">
                                                    <ItemTemplate>
                                                        <asp:HiddenField ID="hdnAllPdf" runat="server" Value='<%#Eval("AllPdf")%>' />
                                                        <img src="images/pdf-icon-trans.png" alt="<%#Eval("pdf")%>" width="30px" height="30px" title="<%#Eval("pdf")%>" />
                                                        <asp:ImageButton ID="imgBtnDeletePdf" runat="server" ImageUrl="images/ico_inactive.png" ValidationGroup='<%#Eval("pdf")%>' class="deletepdf" OnClientClick="return Confirm_Approval_();" CommandName="Delete" />
                                                    </ItemTemplate>
                                                </asp:DataList>
                                            </td>
                                            <td valign="top">
                                                <asp:TextBox ID="txtFaxNo" runat="server" MaxLength="12" onkeyup="mask(event,this);" onkeydown="mask(event,this)"></asp:TextBox>
                                                <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender20" runat="server" TargetControlID="txtFaxNo" FilterType="Numbers,Custom" ValidChars="-"></ajaxToolkit:FilteredTextBoxExtender>
                                            </td>
                                            <td valign="top">
                                                <asp:TextBox ID="txtCntctNum" runat="server" AutoComplete="off" MaxLength="12"
                                ...
                                <div class="section">
                                    <table width="100%" border="0" cellspacing="2" cellpadding="2" id="tblDetails" runat="server">
                                        <tr>
                                            <td width="33%">First Name:
                                            </td>
                                            <td width="33%">Last Name:
                                            </td>
                                            <td>Account:
                                            </td>
                                        </tr>
                                    ...
                                    <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                        <tr>
                                            <td align="center">
                                                ...
                                                <asp:TextBox ID="txtCompanyName" runat="server" MaxLength="30" placeholder="Enter Company Name" Visible="false"
                                                    CssClass="input-class" Style="text-align: center; font-size: xx-large;"></asp:TextBox>
                                ...
                                <div class="section">
                                    ...
                                    <div class="form_box2">
                                        <h1 id="srvc" runat="server">Service Address</h1>
                                        <br />
                                        <br />
                                        <div class="sched">
                                            <ul>
                                                <li>
                                                    ...
                                                    <div class="rgt-txt">
                                                        <asp:TextBox ID="txtAddress_Service" runat="server" TextMode="MultiLine" Width="100%" onkeyup="CheckedChangeAddressOnKeyUP()"></asp:TextBox>
                                ...
                                <div class="section" id="heating" runat="server">
                                    <h1>Heating &amp; WaterHeater &amp; Air Conditioning</h1>
                                    <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                        <tr>
                                            <th width="25%">Heat Source:
                                            </th>
                                            <th width="25%">Heat Type:
                                            </th>
                                            <th width="25%">Water Heater Type:
                                            </th>
                                            <th>Air Conditioning:
                                            </th>
                                        </tr>
                                ...
                                <asp:Panel ID="pnlPPLShow" runat="server" Visible="false">
                                    <div class="section">
                                        <h1>PPL Seasonal Costs and Allowances</h1>
                                        <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                            <tr>
                                                <td width="25%">
                                                    <strong>Yearly KWH </strong>
                                                </td>
                                                <td width="25%">
                                    ...
                                    <div class="section">
                                        <h1>PPL Proprietary Usage</h1>
                                        <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                            <tr>
                                                <td width="33%">On Track:
                                                </td>
                                                <td width="33%">On Track Amount:
                                                </td>
                                                <td width="33%">&nbsp;
                                                </td>
                                            </tr>
                                        ...
                                        <div id="courier" runat="server" style="display: none">
                                            <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                <tr>
                                                    <td colspan="3">
                                                        <h2>Landlord Information <strong>MUST</strong> be completed if you are a Tenant</h2>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Landlord Name:
                                                    </td>
                                                    <td>Landlord Phone (10 digits only):
                                                    </td>
                                                    <td>Email Or Fax:
                                                    </td>
                                                </tr>
                                ...
                                <asp:Panel ID="pnlMetEd" runat="server" Visible="false">
                                    ...
                                    <div class="section">
                                        <h1>MET ED Proprietary Usage</h1>
                                        <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                            <tr>
                                                <td width="25%">PCAP:
                                                </td>
                                                <td width="25%">PCAP Amount:
                                                </td>
                                                <td width="25%">TOD Customer:
                                                </td>
                                                <td>Last 4 SS#:
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>Summer Seasonal Use:
                                                </td>
                                                <td>Winter Seasonal Use:
                                                </td>
                                                <td>Annual Base Use:
                                                </td>
                                                <td>Total Annual Use:
                                            ...
                                            <tr>
                                                <td></td>
                                                <td></td>
                                                <td align="right">Seasonal spending allowance:
                                                </td>
                                                <td>
                                ...
                                <%if (Request.QueryString["Jobs"] != null)
                                    { %>
                                <div class="section">
                                    <h1 id="cntctAttempt" runat="server">Custom Weatherization Contact Attempt(s) <a href="ContactAttemptsReport.aspx?Jobs=<%=Request.QueryString["Jobs"].ToString() %>">Contact Attempts Report </a>
                                    </h1>
                                    <h1 id="Vendornamecomm" runat="server">Vendor Name Communication                                         
                                    </h1>
                                    <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                        <tr>
                                            <td colspan="8">
                                                <h3>To Enter a new <span id="spnCntctattem" runat="server" style="color: Black">contact attempt</span><span id="spncomm" runat="server" style="color: Black">communication</span> simply select from <span id="spn3drpbx" runat="server" style="color: Black">the 3 drop boxes below and the
                                                attempt will be saved when you save the JOB.</span><span id="spn2drpbx" runat="server" style="color: Black">2 boxes and enter agents name and the result will be saved when you click save.</span>
                                                    <br />
                                        ...
                                        <tr>
                                            ...
                                            <td width="19%">Contact Type:
                                            </td>
                                            <td width="20%">Contact Person:
                                            </td>
                                            <td width="20%">
                                                <span id="spnCntctres" runat="server">Contact Result:</span><span id="spnVendorAgent" runat="server">Vendor Agent Name</span>
                                            </td>
                                            <td width="20%"> <span id="spnContactResuldate" runat="server">Contact Result Date:</span><span id="spnAgentId" runat="server">Vendor Agent ID</span>
                                            </td>
                                            <td colspan="2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="txtVendorAgentName" runat="server" MaxLength="30" AutoComplete="off" Width="130px"></asp:TextBox>
                                                <asp:RequiredFieldValidator ValidationGroup="contctAtmpt" ID="rfv_txtVendorAgentName" runat="server" ErrorMessage="*" Display="Dynamic" ControlToValidate="txtVendorAgentName"></asp:RequiredFieldValidator>
                                            ...
                                            <td>
                                                ...
                                                <asp:DropDownList ID="ddltime" AppendDataBoundItems="true" Style="display: none;" onchange="return Confirm_Approval();" runat="server">
                                                ...
                                                <asp:TextBox ID="txtVendorAgentId" runat="server" MaxLength="30" AutoComplete="off" Width="130px"></asp:TextBox>

                                               
                                            </td>
                                            <td>
                                                <asp:RequiredFieldValidator ID="rfv_txtDate_Result" runat="server" ErrorMessage="*"
                                                    ValidationGroup="G" ControlToValidate="txtDate_Result" Enabled="false" Display="Dynamic"></asp:RequiredFieldValidator></td>
                                            <td>
                                ...
                                <div class="section">
                                    <h1>Add a New Comment And/Or Send a message About this <span id="spnJob" runat="server">Job</span><span id="spnVendor" runat="server">Vendor</span> to Other Employee(s)
                                    </h1>
                                    <div align="center">
                                    <asp:TextBox id="txtCommentsSendAnd" runat="server" textmode="multiline" columns="150" rows="20"></asp:TextBox>
                                       
                                        <asp:RequiredFieldValidator ID="rfv_txtCommentsSendAnd" ErrorMessage="*" runat="server" ControlToValidate="txtCommentsSendAnd" Display="Dynamic"></asp:RequiredFieldValidator>
                                    ...
                                    <div class="msg_box1">
                                        <h2 style="text-align: center;">Save Note &amp; Send
                                        <br />
                                            Message</h2>
                                        <div align="center">
                                            ...
                                            <table width="100%" align="center">
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <asp:ListBox ID="lstEmployeeForSendSaveComments" SelectionMode="Multiple" runat="server"></asp:ListBox>
                                                    ...
                                                    <td align="center">
                                                        <asp:ListBox ID="lstEmployeeForSendSaveCommentsCC" SelectionMode="Multiple" runat="server"></asp:ListBox>
                                                    </td>
                                                </tr>
                                            </table>
                                            <br />
                                    ...
                                    <div class="msg_box2">
                                        <h2 style="text-align: center;">Save Note</h2>
                                        <div align="center">
                                            <asp:Button ID="btnSaveComments" runat="server" Text="Save Note Only" OnClientClick="return ConfirmSaveComments();" OnClick="BtnSaveComments_Click" />


                                            <asp:Button ID="btnSaveComments_" runat="server" Text="Save Note Only" ValidationGroup="contctAtmpt" OnClick="btnVendorContactAttempt_Click" />
                                           
                                        </div>
                                        <p>
                                            Enter note and click Save Note Only button. Note will be saved with <span id="spnjb" runat="server">job</span><span id="spnven" runat="server">vendor</span>
                                        and no message
                                    sent.
                                    </div>
                                    <div class="clear">
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <b style="font-size: 15px"><asp:Label ID="lblUserLogin" runat="server" Text='<%#Eval("UserLogin")%>'></asp:Label>
                                                                </b>

                                                               
                                                                <asp:Label ID="lblCCSi" runat="server" ForeColor="Red" Text="Cc" Visible="false" class="hoversize">
                                                    ...
                                                    <tr>
                                                        <td>
                                                        <p style="white-space: pre-wrap;"><%#Eval("Comments")%></p>
