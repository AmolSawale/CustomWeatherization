<%@ page language="C#" masterpagefile="~/Admin/Admin_Master_Page.master" autoeventwireup="true" inherits="Admin_AddAllThing, App_Web_addallthing.aspx.fdf7a39c" title="PPL All Thing" %>
        ...
        <asp:GridView ID="grdAllThing" runat="server" Width="100%" DataKeyNames="RowId" AllowPaging="true"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Location">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txtLocation" runat="server" Text='<%#Eval("location")%>' Width="150px"></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Description">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txtDescription" runat="server" Text='<%#Eval("Description")%>' Width="150px"></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
